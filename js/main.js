...
if (playBtn) { //проверяем есть ли такой класс
	playBtn.addEventListener("click", function (e) {
		playBtn.classList.add('_active');
		videoBg.classList.add('_active');
	});
}
...
if (iconMenu) { //проверяем есть ли такой класс
	const menuBodyContainer = document.querySelector('.bottom-header__container'); //получаем еще один класс в константу
	...
	iconMenu.addEventListener("click", function (e) { //вешаем на иконку событие клик
		...
		menuBodyContainer.classList.toggle('_active');//ставим и убираем класс _active на menu__body каждый раз при клике (для выезда меню при открытии бургера)
